...
module.exports = { getLikeCount, getSongsByUser, uploadSong, getSongsByStatus, getSongsByGenre, getAllSongs, getSongLyrics, getSongById, likeSong, reportSong, getTopSongs, getRecommendedSongs, getPendingSongs, updateSongStatus, updateSong, deleteSong };
