...
router.get("/:id/lyrics", verifyToken, isUser, SongController.getSongLyrics)
      .get("/:id/download", SongController.downloadSong)
      .get("/:id/like", verifyToken, isUser, SongController.getLikeCount)
...
router.get('/by-genre', SongController.getSongsByGenre)
      ...
      .get('/by-user', SongController.getSongsByUser)
      .get('/:id', verifyToken, isUser, SongController.getSongById);
